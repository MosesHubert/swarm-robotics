...
class Button:
    def __init__(self, text, position = (Width-230, 150) , w = 100, h= 50, border=10, color = (0, 0, 0), borderColor = (64, 123, 158)):
        self.text = text
...
class Panel:
    def __init__(self, position = (Width-350, 25), w= 345, h= 200, color=(8, 3, 12), alpha=128):
        self.position = position
        self.w = w
        self.h = h
        self.color = color
...
class ToggleButton:
    def __init__(self, position= ((Width-200, 550)), w = 30, h=30, state=False, color=(40, 40, 10), activeColor=(240, 140, 60)):
        self.position = position
        self.w = w
        self.h = h
        self.clicked = False
