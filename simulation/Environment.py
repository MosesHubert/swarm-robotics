...
class Environment:
    def __init__(self, agents, epsilon, learning_rate, discount_factor, separation_magnitude, cohesion_magnitude, alignment_magnitude, max_speed, max_length, width, height, inner_sensor, outer_sensor, agent_size):
        self.action_class = Action(agents, max_speed, max_length, separation_magnitude, alignment_magnitude, cohesion_magnitude)
        self.state_class = State(width, height, inner_sensor, outer_sensor, agent_size)
        self.agents = agents
