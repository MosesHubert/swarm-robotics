...
class VirtualArena:
    def __init__(self, width, height, text_font, obstacle_text_size, terminal_text_size, testing_text_size, text_color, testing_text_color):
        pygame.init()
        ...
        self.font_testing = pygame.font.SysFont(text_font, testing_text_size, bold=True)
        ...
        self.text_testing = self.font_testing.render('TESTING', False, testing_text_color)
    ...
    def draw_text(self, obstacle_text_position, start_text_position, target_text_position, testing_text_position):
        ...
        self.surface.blit(self.text_testing, testing_text_position)
